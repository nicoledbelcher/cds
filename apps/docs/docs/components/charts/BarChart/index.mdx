...
import webPropsToc from ':docgen/web/visualizations/chart/bar/BarChart/toc-props';
import mobilePropsToc from ':docgen/mobile/visualizations/chart/bar/BarChart/toc-props';
