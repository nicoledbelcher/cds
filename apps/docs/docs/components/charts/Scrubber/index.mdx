...
import webPropsToc from ':docgen/web/visualizations/chart/scrubber/Scrubber/toc-props';
import mobilePropsToc from ':docgen/mobile/visualizations/chart/scrubber/Scrubber/toc-props';
