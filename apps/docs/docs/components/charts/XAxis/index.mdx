...
import webPropsToc from ':docgen/web/visualizations/chart/axis/XAxis/toc-props';
import mobilePropsToc from ':docgen/mobile/visualizations/chart/axis/XAxis/toc-props';
