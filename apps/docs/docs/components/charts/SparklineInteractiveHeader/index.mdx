...
import webPropsToc from ':docgen/web/visualizations/sparkline/sparkline-interactive-header/SparklineInteractiveHeader/toc-props';
import mobilePropsToc from ':docgen/mobile/visualizations/sparkline/sparkline-interactive-header/SparklineInteractiveHeader/toc-props';
