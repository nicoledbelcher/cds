...
import webPropsToc from ':docgen/web/visualizations/chart/axis/YAxis/toc-props';
import mobilePropsToc from ':docgen/mobile/visualizations/chart/axis/YAxis/toc-props';
