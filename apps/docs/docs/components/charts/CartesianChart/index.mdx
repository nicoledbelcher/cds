...
import webPropsToc from ':docgen/web/visualizations/chart/CartesianChart/toc-props';
import mobilePropsToc from ':docgen/mobile/visualizations/chart/CartesianChart/toc-props';
