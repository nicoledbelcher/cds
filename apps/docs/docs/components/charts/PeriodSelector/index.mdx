...
import webPropsToc from ':docgen/web/visualizations/chart/PeriodSelector/toc-props';
import mobilePropsToc from ':docgen/mobile/visualizations/chart/PeriodSelector/toc-props';
