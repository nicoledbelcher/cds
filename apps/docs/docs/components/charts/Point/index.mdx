...
import webPropsToc from ':docgen/web/visualizations/chart/point/Point/toc-props';
import mobilePropsToc from ':docgen/mobile/visualizations/chart/point/Point/toc-props';
