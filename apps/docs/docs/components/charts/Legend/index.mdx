...
import webPropsToc from ':docgen/web/visualizations/chart/legend/Legend/toc-props';
import mobilePropsToc from ':docgen/mobile/visualizations/chart/legend/Legend/toc-props';
