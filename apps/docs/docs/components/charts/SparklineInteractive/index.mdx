...
import webPropsToc from ':docgen/web/visualizations/sparkline/sparkline-interactive/SparklineInteractive/toc-props';
import mobilePropsToc from ':docgen/mobile/visualizations/sparkline/sparkline-interactive/SparklineInteractive/toc-props';
