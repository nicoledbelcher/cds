...
import webPropsToc from ':docgen/web/visualizations/sparkline/Sparkline/toc-props';
import mobilePropsToc from ':docgen/mobile/visualizations/sparkline/Sparkline/toc-props';
