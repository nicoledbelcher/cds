...
import webPropsToc from ':docgen/web/visualizations/chart/area/AreaChart/toc-props';
import mobilePropsToc from ':docgen/mobile/visualizations/chart/area/AreaChart/toc-props';
