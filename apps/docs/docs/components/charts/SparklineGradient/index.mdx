...
import webPropsToc from ':docgen/web/visualizations/sparkline/SparklineGradient/toc-props';
import mobilePropsToc from ':docgen/mobile/visualizations/sparkline/SparklineGradient/toc-props';
