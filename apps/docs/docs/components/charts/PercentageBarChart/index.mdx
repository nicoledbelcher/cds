...
import webPropsToc from ':docgen/web/visualizations/chart/bar/PercentageBarChart/toc-props';
import mobilePropsToc from ':docgen/mobile/visualizations/chart/bar/PercentageBarChart/toc-props';
