  ...
  const AssetPriceChart = memo(() => {
    ...
    return (
      <VStack gap={2}>
        ...
        {showSettings && (
          <Tray
            pin={breakpoints.isPhone ? 'bottom' : 'right'}
            showHandleBar={breakpoints.isPhone}
          ...
          >
            <ListCell
              ...
              title="Show Y-Axis"
              end={<Switch checked={showYAxis} onChange={toggleShowYAxis} />}
              innerSpacing={{ marginX: -4, paddingX: 4, paddingY: 1 }}
            />
            <ListCell
              spacingVariant="condensed"
              title="Show X-Axis"
              end={<Switch checked={showXAxis} onChange={toggleShowXAxis} />}
              innerSpacing={{ marginX: -4, paddingX: 4, paddingY: 1 }}
            />
          </Tray>
        )}
