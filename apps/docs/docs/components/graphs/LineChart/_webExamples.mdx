...
<Playground
  files={{
    "Example.tsx": `import { useMemo, useCallback } from 'react';
import { MonotoneAssetPriceChart } from './MonotoneAssetPriceChart';
import { MonotoneScrubberBeacon } from './MonotoneScrubberBeacon';

function Example() {
  return <MonotoneAssetPriceChart BeaconComponent={MonotoneScrubberBeacon} />;
}

render(<Example />);`,
    "./MonotoneAssetPriceChart.tsx": `import { useMemo, useCallback } from 'react';
import { LineChart } from '@coinbase/cds-web/visualizations';
import { Scrubber, SolidLine, DefaultAxisTickLabel } from '@coinbase/cds-web-visualization/chart';
import { sparklineInteractiveData } from '@coinbase/cds-common/internal/visualizations/SparklineInteractiveData';

export function MonotoneAssetPriceChart({ BeaconComponent }) {
  ...
  return (
    ...
    "./MonotoneScrubberBeacon.tsx": `import { memo, forwardRef, useMemo, useImperativeHandle } from 'react';
import { useCartesianChartContext, projectPoint, defaultTransition, ScrubberBeaconProps } from '@coinbase/cds-web-visualization/chart';
import { motion as m } from 'framer-motion';

export const MonotoneScrubberBeacon = memo(
...
>
{`// Main file (Example.tsx) - editable
