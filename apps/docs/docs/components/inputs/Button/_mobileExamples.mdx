...
- **Tertiary** — Low emphasis with a muted background.
- **Inverse** — High contrast with inverted background.
...
<HStack gap={2} flexWrap="wrap">
  ...
  <Button onPress={console.log} variant="inverse">
    Inverse
  </Button>
...
<HStack gap={2}>
  ...
  <Button onPress={console.log} variant="tertiary" transparent>
    Tertiary
  </Button>
  <Button onPress={console.log} variant="inverse" transparent>
    Inverse
  </Button>
