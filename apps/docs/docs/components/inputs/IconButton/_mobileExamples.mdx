...
Use `iconSize` to customize the icon independently from the button's target area.
...
<HStack gap={2} alignItems="center">
  <IconButton
    name="gear"
    iconSize="xs"
    accessibilityLabel="Settings - extra small icon"
    onPress={console.log}
  />
  <IconButton
    name="gear"
    iconSize="s"
    accessibilityLabel="Settings - small icon"
    onPress={console.log}
  />
  <IconButton
    name="gear"
    iconSize="m"
    accessibilityLabel="Settings - medium icon"
    onPress={console.log}
  />
  <IconButton
    name="gear"
    iconSize="l"
    compact={false}
    accessibilityLabel="Settings - large icon"
    onPress={console.log}
  />
</HStack>
```
