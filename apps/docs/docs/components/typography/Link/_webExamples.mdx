...
Use `underlineVariant="dotted"` with `underline` when the design calls for a dotted treatment.

```jsx live
<Text as="p" display="block" font="body">
  Review our{' '}
  <Link underline underlineVariant="dotted" href="https://www.coinbase.com/">
    account terms
  </Link>{' '}
  before continuing.
</Text>
