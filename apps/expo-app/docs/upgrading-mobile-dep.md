...
Check out this doc [for more about mobile builds in general](/apps/expo-app/docs/building-mobile.md)
...
```shell
yarn workspace expo-app add <dependency name>@<version>
...
3. Test that your applications work locally as expected. You will need to build a new debug build & likely uninstall the previous application and reinstall your new build, following [setup instructions](/apps/expo-app/README.md).
