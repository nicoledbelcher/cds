...
Check out this doc [for more about mobile builds in general](/apps/test-expo/docs/building-mobile.md)
...
```shell
yarn workspace test-expo add <dependency name>@<version>
...
3. Test that your applications work locally as expected. You will need to build a new debug build & likely uninstall the previous application and reinstall your new build, following [setup instructions](/apps/test-expo/README.md).
