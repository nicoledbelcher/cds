import{r as t,j as e,B as c}from"./iframe-CYDANtMt.js";import{T as y}from"./Text-0g3rWpAf.js";import{p as j,a as R,s as w,b as T,C as M}from"./ColorSurge-COlvd6LS.js";import{c as C}from"./utils-CM_X5is-.js";import{u as S}from"./use-animation-B-MH_N0S.js";import{m as x}from"./motion-minimal-B1h7XI-_.js";import{V as k}from"./VStack-iXgNewwv.js";import{B as o}from"./Button-DPtA13Wn.js";import"./preload-helper-D9Z9MdNV.js";import"./tokens-BwScSksM.js";import"./useMotionProps-BF3bCUsm.js";import"./Icon-DRxKkZdt.js";import"./useTheme-C_Ehsh33.js";import"./Spinner-CXotWqqb.js";import"./Pressable-BvczHaFK.js";import"./isArray-BJmyNVUi.js";import"./Interactable-DhvzqrPU.js";import"./color-Ceo1QMNe.js";const N=n=>n===void 0||n===1/0?1/0:n>0?n-1:0,b=t.memo(t.forwardRef(function({children:a,variant:r="moderate",disableAnimateOnMount:i=!1,iterations:l,motionConfig:s},g){const u=S(),d=t.useCallback(()=>{u.stop(),u.set({opacity:1})},[u]),v=t.useMemo(()=>N(l),[l]),h=t.useCallback(async B=>{d(),await u.start({opacity:[1,j[B??r],1],transition:C({...R,...s||{},repeat:v})})},[d,u,r,v,s]);return t.useEffect(()=>{i||h()},[h,i]),t.useImperativeHandle(g,()=>({play:h,stop:d}),[h,d]),e.jsx(x.div,{animate:u,children:a})}));b.__docgenInfo={description:"Please consult with the motion team in #ask-motion before using this component.",methods:[],displayName:"Pulse",props:{disableAnimateOnMount:{required:!1,tsType:{name:"boolean"},description:`Disable animation on component mount
