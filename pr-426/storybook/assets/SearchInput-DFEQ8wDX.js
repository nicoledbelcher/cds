import{r as e,j as i,c as S,B}from"./iframe-CYDANtMt.js";import{u as L}from"./useMergeRefs-DR4sGa7m.js";import{I as R}from"./InputIcon-DVp1nZL_.js";import{I as x}from"./InputIconButton-CL-x4fcy.js";import{T as D}from"./TextInput-D1xg7XYw.js";const T="baseCss-b12dhwku",q="compactCss-c1msm7zg",M=e.memo(e.forwardRef(function({onChange:m,onClear:s,onChangeText:n,onSearch:t,testID:l,value:r,compact:u,hideStartIcon:d=!1,bordered:p=!0,hideEndIcon:h,startIcon:o,end:g,startIconAccessibilityLabel:c="Back",clearIconAccessibilityLabel:b="Clear search query",...f},w){const v=e.useRef(null),k=L(w,v),y=e.useCallback(a=>{m?.(a),n?.(a.target.value)},[m,n]),C=e.useCallback(a=>{a.key==="Enter"&&t?.(r?.toString()??"")},[t,r]),P=e.useCallback(a=>{s?.(a),v.current?.focus(),n?.(""),t?.("")},[s,n,t]),A=e.useMemo(()=>o==="backArrow"?c:void 0,[c,o]);return i.jsx(D,{ref:k,borderRadius:1e3,bordered:p,className:S(T,u&&q),end:g??(!!r&&!h&&i.jsx(B,{marginEnd:u?-.5:0,paddingEnd:u?0:.5,children:i.jsx(x,{accessibilityLabel:b,name:"close",onClick:P,testID:l&&`${l}-close-iconbtn`})})),onChange:y,onKeyUp:C,role:"searchbox",start:!d&&i.jsx(R,{accessibilityLabel:A,name:o??"search",testID:l&&`${l}-search-icon`}),testID:l,type:"search",value:r,variant:"secondary",...f})}));M.__docgenInfo={description:"",methods:[],displayName:"SearchInput",props:{onSearch:{required:!1,tsType:{name:"signature",type:"function",raw:"(str: string) => void",signature:{arguments:[{type:{name:"string"},name:"str"}],return:{name:"void"}}},description:`Callback is fired when a user hits enter on the keyboard. Can obtain the query
through str parameter`},hideStartIcon:{required:!1,tsType:{name:"boolean"},description:`hide the start icon
@default false`,defaultValue:{value:"false",computed:!1}},startIcon:{required:!1,tsType:{name:"Extract",elements:[{name:"union",raw:`| 'account'
| 'activity'
| 'add'
| 'addPeople'
