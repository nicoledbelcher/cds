import{r as a,j as d,c as A,u as ye}from"./iframe-BXWLBCkp.js";import{T as U}from"./Text-Ch_dBU4v.js";import{m as M}from"./motion-minimal-SVRWJYUW.js";import{c as Q,d as X}from"./tokens-BwScSksM.js";import{u as fe}from"./LocaleProvider-BsopcHeG.js";import{H as ve}from"./HStack-B6p8qBpp.js";import{a as Z}from"./animate-Ctc6D7xG.js";import{u as ge}from"./useTheme-BJazYlse.js";import{u as ke}from"./use-animation-CYeuSrS_.js";const we=M(U),Se="containerCss-caphhbo",ie=a.memo(a.forwardRef(({children:t,color:n="inherit",justifyContent:o="flex-start",className:l,styles:i,style:s,classNames:u,...b},h)=>d.jsx(we,{ref:h,className:A(Se,l,u?.root,u?.text),color:n,justifyContent:o,style:{...s,...i?.root,...i?.text},...b,children:t})));ie.__docgenInfo={description:"",methods:[],displayName:"DefaultRollingNumberAffixSection",props:{children:{required:!1,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:"Content rendered inside the affix section."},ref:{required:!1,tsType:{name:"ReactRef",raw:"React.Ref<HTMLSpanElement>",elements:[{name:"HTMLSpanElement"}]},description:"Ref forwarded to the affix section wrapper element."},styles:{required:!1,tsType:{name:"signature",type:"object",raw:`{
