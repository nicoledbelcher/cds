import{r as o,j as a}from"./iframe-CYDANtMt.js";import{a as i}from"./assets-CEwpm_uP.js";import{i as ie,S as se,u as T}from"./DefaultSelectControl-D7XmFGZ1.js";import{V as E}from"./VStack-iXgNewwv.js";import{R as H}from"./RemoteImage-S3YFINhn.js";import{R as re}from"./RemoteImageGroup-ggI0q1ph.js";import{A as pe}from"./AnimatedCaret-R2z7TxpB.js";import{M as ue}from"./MediaChip-2PB0UFrW.js";import"./preload-helper-D9Z9MdNV.js";import"./floating-ui.react-dom-CVxlbkL8.js";import"./Portal-BNKVVywf.js";import"./useTheme-C_Ehsh33.js";import"./Divider-CG0S6-JI.js";import"./select-Em8pkxbY.js";import"./Cell-D1A-2vVj.js";import"./useCellSpacing-BH3_o_ol.js";import"./sizing-Do56D2dQ.js";import"./HStack-Fh-9TmPm.js";import"./Pressable-BvczHaFK.js";import"./isArray-BJmyNVUi.js";import"./Interactable-DhvzqrPU.js";import"./color-Ceo1QMNe.js";import"./Text-0g3rWpAf.js";import"./InputChip-B31f2sLo.js";import"./Icon-DRxKkZdt.js";import"./HelperText-0iJbV5oL.js";import"./InputLabel-BwQhf82V.js";import"./InputStack-uMkha90v.js";import"./tokens-BwScSksM.js";import"./ColorSurge-COlvd6LS.js";import"./useMotionProps-BF3bCUsm.js";import"./utils-CM_X5is-.js";import"./use-animation-B-MH_N0S.js";import"./motion-minimal-B1h7XI-_.js";import"./Checkbox-DVQ8jHPo.js";import"./checkbox-DVjU0upZ.js";import"./Control-C-1dn_y_.js";import"./useMergeRefs-DR4sGa7m.js";import"./usePrefixedId-D1yZvkEs.js";import"./isRtl-CGZsgYct.js";import"./Radio-Cz5dwyfU.js";import"./FocusTrap-D5jofIBF.js";import"./debounce-fynzmAtJ.js";import"./index-DaxQGrHc.js";import"./use-unmount-effect-DjWyEMV9.js";import"./Button-DPtA13Wn.js";import"./Spinner-CXotWqqb.js";import"./collapsible-BAneA-61.js";import"./context-C9K9uJvD.js";import"./index-CAK1E_4V.js";import"./Chip-DQPBsLRY.js";const F=o.memo(o.forwardRef(({type:l,options:e,value:t,placeholder:s,setOpen:r,startNode:c,endNode:m,open:j,accessibilityLabel:$,ariaHaspopup:z="listbox",className:J,style:K,maxSelectedOptionsToShow:D=2,hiddenSelectedOptionsLabel:U="more",label:B,compact:Q,invertColorScheme:X,numberOfLines:Y,disabled:Z,maxWidth:ee,displayValue:M},te)=>{const P=l==="multi",d=t!==null&&!(Array.isArray(t)&&t.length===0),W=o.useMemo(()=>{const p=new Map;return e.forEach((b,G)=>{if(ie(b))b.options.forEach((u,h)=>{if(u.value!==null){const A=u.value;p.has(A)||p.set(A,u)}});else{const u=b;if(u.value!==null){const h=u.value;p.has(h)||p.set(h,u)}}}),p},[e]),le=o.useMemo(()=>{if(!d)return B??s??null;if(M)return M;if(P){const b=t,G=b.slice(0,D),u=G.map(A=>{const _=W.get(A);return _?.label??_?.description??_?.value??""}).filter(Boolean),h=b.length-G.length;return h>0?`${u.join(", ")} +${h} ${U}`:u.join(", ")}const p=W.get(t);return p?.label??p?.description??p?.value??s??null},[d,B,s,M,P,W,t,D,U]),ae=o.useMemo(()=>m??a.jsx(pe,{active:!0,color:d?"fgInverse":"fg",rotate:j?0:180,size:"xs"}),[m,d,j]),oe=o.useMemo(()=>d?"fgInverse":"fg",[d]),ne=o.useMemo(()=>d?"bgInverse":"bgSecondary",[d]);return a.jsx(ue,{ref:te,noScaleOnPress:!0,accessibilityLabel:$,"aria-haspopup":z,background:ne,className:J,color:oe,compact:Q,disabled:Z,end:ae,invertColorScheme:X,maxWidth:ee,numberOfLines:Y,onClick:()=>r(p=>!p),start:c,style:K,children:le})})),ce=F;F.__docgenInfo={description:"",methods:[],displayName:"SelectChipControlComponent",props:{value:{required:!0,tsType:{name:"unknown"},description:""},onChange:{required:!0,tsType:{name:"signature",type:"function",raw:`(
