import{r as i,j as e}from"./iframe-BXWLBCkp.js";import{S as c}from"./Scrubber-ByXqK5c_.js";import{g as se,d as le,C as de,X as ue,Y as me,c as pe,D as ce}from"./Axis-BOWgFUiH.js";import{A as he,L as fe}from"./Line-DHCp7DPs.js";import{V as k}from"./VStack-CnEfMFeL.js";import{T as be}from"./Text-Ch_dBU4v.js";import"./preload-helper-D9Z9MdNV.js";import"./use-animate-xDzL-Uuk.js";import"./motion-minimal-SVRWJYUW.js";import"./use-unmount-effect-5QIafHMH.js";import"./animate-Ctc6D7xG.js";import"./useRefMap-so5XoaSx.js";import"./d3-interpolate-path-DAdKSvnf.js";import"./color-Ceo1QMNe.js";import"./useDimensions-CSIQgsxn.js";import"./HStack-B6p8qBpp.js";import"./use-transform-BtSRjA0i.js";const r=i.memo(i.forwardRef(({series:t,stacked:l,AreaComponent:m,curve:h,fillOpacity:x,type:w,connectNulls:f,transition:b,LineComponent:P,strokeWidth:C,showXAxis:S,showYAxis:T,showLines:A,lineType:q="solid",xAxis:I,yAxis:R,inset:y,children:D,...G},W)=>{const O=i.useMemo(()=>se(y,pe),[y]),o=i.useMemo(()=>t?.map(n=>({id:n.id,data:n.data,label:n.label,color:n.color,yAxisId:n.yAxisId,stackId:n.stackId,gradient:n.gradient})),[t]),L=i.useMemo(()=>!l||!o?o:o.map(n=>({...n,stackId:n.stackId??le})),[o,l])??o,{scaleType:V,data:E,categoryPadding:B,domain:j,domainLimit:M,range:N,...z}=I||{},{scaleType:F,data:U,categoryPadding:H,domain:v,domainLimit:$,range:Y,id:X,..._}=R||{},J={scaleType:V,data:E,categoryPadding:B,domain:j,domainLimit:M,range:N},K=i.useMemo(()=>t?t.some(n=>n.data?.some(a=>typeof a=="number"&&a<0||Array.isArray(a)&&a.some(d=>typeof d=="number"&&d<0))):!1,[t]),Q={scaleType:F,data:U,categoryPadding:H,domain:K?v:{min:0,...v},domainLimit:$,range:Y};return e.jsxs(de,{...G,ref:W,inset:O,series:L,xAxis:J,yAxis:Q,children:[S&&e.jsx(ue,{...z}),T&&e.jsx(me,{axisId:X,..._}),t?.map(({id:n,data:a,label:d,color:Z,yAxisId:ee,opacity:ne,LineComponent:te,stackId:ae,legendShape:ie,transition:g,...p})=>e.jsx(he,{AreaComponent:m,connectNulls:f,curve:h,fillOpacity:x,seriesId:n,transition:g??b,type:w,...p},n)),A&&t?.map(({id:n,data:a,label:d,color:Z,yAxisId:ee,fill:ne,fillOpacity:te,stackId:ae,legendShape:ie,type:g,lineType:p,transition:re,...oe})=>e.jsx(fe,{LineComponent:P,connectNulls:f,curve:h,seriesId:n,strokeWidth:C,transition:re??b,type:p??q,...oe},n)),D]})}));r.__docgenInfo={description:"",methods:[],displayName:"AreaChart",props:{series:{required:!1,tsType:{name:"Array",elements:[{name:"intersection",raw:`Series &
Partial<
  Pick<
    AreaProps,
...
Can be a preset shape variant or a custom ReactNode.
@default 'circle'`}]}},{name:"Partial",elements:[{name:"Pick",elements:[{name:"intersection",raw:`AreaBaseProps & {
  /**
...
@default 'solid'`},{key:"AreaComponent",value:{name:"ReactFC",raw:"React.FC<AreaComponentProps>",elements:[{name:"intersection",raw:`Pick<
  AreaProps,
...
> & {
   ...
   */
  yAxisId?: string;
}`,elements:[{name:"Pick",elements:[{name:"AreaProps"},{name:"union",raw:"'fill' | 'fillOpacity' | 'baseline' | 'gradient' | 'animate' | 'transition'",elements:[{name:"literal",value:"'fill'"},{name:"literal",value:"'fillOpacity'"},{name:"literal",value:"'baseline'"},{name:"literal",value:"'gradient'"},{name:"literal",value:"'animate'"},{name:"literal",value:"'transition'"}]}],raw:`Pick<
  AreaProps,
  'fill' | 'fillOpacity' | 'baseline' | 'gradient' | 'animate' | 'transition'
...
If not provided, defaults to the default y-axis.`}]}}]}],required:!1},description:`Component to render the area.
...
Overrides the animate value from the chart context.`}]}},{name:"signature",type:"object",raw:`{
   ...
   */
  transition?: Transition;
}`,signature:{properties:[{key:"transition",value:{name:"Transition",required:!1},description:"Transition configuration for path animations."}]}}]},{name:"union",raw:"'AreaComponent' | 'curve' | 'fillOpacity' | 'type' | 'fill' | 'connectNulls' | 'transition'",elements:[{name:"literal",value:"'AreaComponent'"},{name:"literal",value:"'curve'"},{name:"literal",value:"'fillOpacity'"},{name:"literal",value:"'type'"},{name:"literal",value:"'fill'"},{name:"literal",value:"'connectNulls'"},{name:"literal",value:"'transition'"}]}],raw:`Pick<
  AreaProps,
  'AreaComponent' | 'curve' | 'fillOpacity' | 'type' | 'fill' | 'connectNulls' | 'transition'
>`}],raw:`Partial<
  Pick<
    ...
    'AreaComponent' | 'curve' | 'fillOpacity' | 'type' | 'fill' | 'connectNulls' | 'transition'
  >
>`},{name:"Partial",elements:[{name:"Pick",elements:[{name:"intersection",raw:`LineBaseProps & {
  /**
...
Passed through to Point components rendered via points.`},{key:"style",value:{name:"ReactCSSProperties",raw:"React.CSSProperties",required:!1},description:"Custom style for the line."},{key:"className",value:{name:"string",required:!1},description:"Custom className for the line."}]}}]},{name:"union",raw:"'LineComponent' | 'strokeWidth' | 'stroke' | 'opacity'",elements:[{name:"literal",value:"'LineComponent'"},{name:"literal",value:"'strokeWidth'"},{name:"literal",value:"'stroke'"},{name:"literal",value:"'opacity'"}]}],raw:"Pick<LineProps, 'LineComponent' | 'strokeWidth' | 'stroke' | 'opacity'>"}],raw:"Partial<Pick<LineProps, 'LineComponent' | 'strokeWidth' | 'stroke' | 'opacity'>>"},{name:"signature",type:"object",raw:`{
  /**
   * The type of line to render for this series.
   * Overrides the chart-level lineType if provided.
   * @default 'solid'
   */
  lineType?: 'solid' | 'dotted';
}`,signature:{properties:[{key:"lineType",value:{name:"union",raw:"'solid' | 'dotted'",elements:[{name:"literal",value:"'solid'"},{name:"literal",value:"'dotted'"}],required:!1},description:`The type of line to render for this series.
Overrides the chart-level lineType if provided.
@default 'solid'`}]}}]}],raw:"Array<AreaSeries>"},description:`Configuration objects that define how to visualize the data.
Each series supports Area and Line component props for individual customization.`},stacked:{required:!1,tsType:{name:"boolean"},description:`Whether to stack the areas on top of each other.
...
and rendered as-is.`},showXAxis:{required:!1,tsType:{name:"boolean"},description:"Whether to show the X axis."},showYAxis:{required:!1,tsType:{name:"boolean"},description:"Whether to show the Y axis."},showLines:{required:!1,tsType:{name:"boolean"},description:`Whether to show lines on top of the areas.
Useful for stacked contexts to show the outline of each area.`},lineType:{required:!1,tsType:{name:"union",raw:"'solid' | 'dotted'",elements:[{name:"literal",value:"'solid'"},{name:"literal",value:"'dotted'"}]},description:`The type of line to render.
@default 'solid'`,defaultValue:{value:"'solid'",computed:!1}},xAxis:{required:!1,tsType:{name:"intersection",raw:"Partial<AxisConfigProps> & XAxisProps",elements:[{name:"Partial",elements:[{name:"intersection",raw:`Omit<AxisConfig, 'domain' | 'range'> & {
  /**
...
@default 44 when no label is provided, 64 when a label is provided`}]}}]}]}]},description:"Configuration for y-axis.\nAccepts axis config and axis props.\nTo show the axis, set `showYAxis` to true."}}};const Le={title:"Components/Chart/AreaChart",component:r},u=({children:t,title:l,description:m})=>e.jsxs(k,{gap:2,children:[e.jsx(be,{as:"h2",display:"block",font:"title3",children:l}),m,t]}),s=()=>e.jsxs(k,{gap:2,children:[e.jsx(u,{title:"Basic",children:e.jsx(r,{enableScrubbing:!0,showYAxis:!0,height:400,series:[{id:"pageViews",data:[24,13,98,39,48,38,43]}],yAxis:{showGrid:!0,domain:{min:0}},children:e.jsx(c,{})})}),e.jsx(u,{title:"Stacked",children:e.jsx(r,{enableScrubbing:!0,showLines:!0,stacked:!0,curve:"natural",height:256,series:[{id:"currentRewards",data:[100,150,200,280,380,500,650,820,1020,1250,1510,1800,2120,2470,2850,3260,3700,4170],color:"var(--color-fg)"},{id:"potentialRewards",data:[150,220,300,400,520,660,820,1e3,1200,1420,1660,1920,2200,2500,2820,3160,3520,3900],color:"var(--color-fgPositive)",type:"dotted",LineComponent:ce}],type:"dotted",children:e.jsx(c,{})})}),e.jsx(u,{title:"Negative Values",children:e.jsx(r,{enableScrubbing:!0,showLines:!0,showYAxis:!0,height:400,series:[{id:"pageViews",data:[24,13,-98,39,48,38,43]}],type:"gradient",yAxis:{showGrid:!0},children:e.jsx(c,{})})}),e.jsx(u,{title:"Styles",children:e.jsx(r,{enableScrubbing:!1,height:350,series:[{id:"visitors",data:[450,520,480,600,750,680,590],label:"Weekly Visitors",color:"#fb4d3d",type:"dotted"},{id:"repeatVisitors",data:[250,200,150,140,100,80,50],label:"Weekly Repeat Visitors",color:"#16a34a"},{id:"signups",data:[45,62,55,250,380,400,450],label:"Weekly Signups",color:"#2563eb",type:"gradient"}]})})]});s.__docgenInfo={description:"",methods:[],displayName:"All"};s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`() => {
  return <VStack gap={2}>
      <Example title="Basic">
        <AreaChart enableScrubbing showYAxis height={400} series={[{
        id: 'pageViews',
      ...
      <Example title="Stacked">
        <AreaChart enableScrubbing showLines stacked curve="natural" height={256} series={[{
        id: 'currentRewards',
      ...
      <Example title="Negative Values">
        <AreaChart enableScrubbing showLines showYAxis height={400} series={[{
        id: 'pageViews',
        data: [24, 13, -98, 39, 48, 38, 43]
      }]} type="gradient" yAxis={{
        showGrid: true
      ...
      <Example title="Styles">
        <AreaChart enableScrubbing={false} height={350} series={[{
        id: 'visitors',
...
}`,...s.parameters?.docs?.source}}};const Ve=["All"];export{s as All,Ve as __namedExportsOrder,Le as default};
