import{r as n,j as r,c}from"./iframe-BXWLBCkp.js";const u=n.createContext({variant:"default",compact:!1}),x="tableCss-t46ubha",q="tableFixedCss-t140lncs",S="tableContainerCss-to5vovb",I="tableContainerBorderCss-t3so5k5",P="tableVariantDefaultCss-t1agmoqy",B="tableVariantGraphCss-t1p23l0l",C="tableVariantRuledCss-t55vlqo",D={default:P,graph:B,ruled:C},m=n.forwardRef(function({children:t,variant:a="default",bordered:i,cellSpacing:o,testID:p,tableLayout:y,compact:l,maxHeight:d,height:b,accessibilityLabelledBy:h,accessibilityLabel:g,className:f,...k},v){const T=n.useMemo(()=>({variant:a,cellSpacing:o,compact:l}),[a,o,l]),w=y==="fixed",A=n.useMemo(()=>({"--table-height":`${b}px`,"--table-maxHeight":`${d}px`}),[b,d]);return r.jsx(u.Provider,{value:T,children:r.jsx("div",{className:c(S,i&&I,a&&D[a]),style:A,children:r.jsx("table",{ref:v,"aria-label":g,"aria-labelledby":h,className:c(x,w&&q,f),"data-testid":p,...k,children:t})})})}),R=n.memo(m);R.displayName="Table";m.__docgenInfo={description:"",methods:[],displayName:"TableWithRef",props:{testID:{required:!1,tsType:{name:"string"},description:`Used to locate this element in unit and end-to-end tests.
Under the hood, testID translates to data-testid on Web. On Mobile, testID
stays the same - testID`},variant:{required:!1,tsType:{name:"union",raw:"'default' | 'graph' | 'ruled'",elements:[{name:"literal",value:"'default'"},{name:"literal",value:"'graph'"},{name:"literal",value:"'ruled'"}]},description:`The variant prop allows clients to use a
CDS approved style for their Table.
@default undefined`,defaultValue:{value:"'default'",computed:!1}},children:{required:!0,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:`Children are required, and should always include a TableBody.
TableHeader and TableFooter are both optional, and will magically
flow into the correct place in the table (top/bottom)`},bordered:{required:!1,tsType:{name:"boolean"},description:"When set, a border will be applied around the entire table"},tableLayout:{required:!1,tsType:{name:"union",raw:"'auto' | 'fixed'",elements:[{name:"literal",value:"'auto'"},{name:"literal",value:"'fixed'"}]},description:`Use tableLayout='fixed' if you need full control over cell width
@default 'auto'`},cellSpacing:{required:!1,tsType:{name:"signature",type:"object",raw:`{
  inner?: CellSpacing;
  outer?: CellSpacing;
}`,signature:{properties:[{key:"inner",value:{name:"Pick",elements:[{name:"intersection",raw:`StyleProps &
SharedProps &
Pick<
...
| 'marginEnd'
| 'marginBottom'
| 'marginStart'`,elements:[{name:"literal",value:"'padding'"},{name:"literal",value:"'paddingX'"},{name:"literal",value:"'paddingY'"},{name:"literal",value:"'paddingTop'"},{name:"literal",value:"'paddingEnd'"},{name:"literal",value:"'paddingBottom'"},{name:"literal",value:"'paddingStart'"},{name:"literal",value:"'margin'"},{name:"literal",value:"'marginX'"},{name:"literal",value:"'marginY'"},{name:"literal",value:"'marginTop'"},{name:"literal",value:"'marginEnd'"},{name:"literal",value:"'marginBottom'"},{name:"literal",value:"'marginStart'"}]}],raw:`Pick<
  BoxBaseProps,
  | 'padding'
  | 'paddingX'
  | 'paddingY'
  ...
  | 'marginBottom'
  | 'marginStart'
>`,required:!1}},{key:"outer",value:{name:"Pick",elements:[{name:"intersection",raw:`StyleProps &
SharedProps &
Pick<
  SharedAccessibilityProps,
  'accessibilityLabel' | 'accessibilityLabelledBy' | 'accessibilityHint'
...
| 'marginStart'`,elements:[{name:"literal",value:"'padding'"},{name:"literal",value:"'paddingX'"},{name:"literal",value:"'paddingY'"},{name:"literal",value:"'paddingTop'"},{name:"literal",value:"'paddingEnd'"},{name:"literal",value:"'paddingBottom'"},{name:"literal",value:"'paddingStart'"},{name:"literal",value:"'margin'"},{name:"literal",value:"'marginX'"},{name:"literal",value:"'marginY'"},{name:"literal",value:"'marginTop'"},{name:"literal",value:"'marginEnd'"},{name:"literal",value:"'marginBottom'"},{name:"literal",value:"'marginStart'"}]}],raw:`Pick<
  ...
  | 'marginBottom'
  | 'marginStart'
>`,required:!1}}]}},description:"Provide custom cell spacing for all child TableCells"},compact:{required:!1,tsType:{name:"boolean"},description:"Use compact cell spacing. If set, cellSpacing will override these defaults"},height:{required:!1,tsType:{name:"union",raw:"'auto' | FixedValue | PercentageValue",elements:[{name:"literal",value:"'auto'"},{name:"union",raw:"number | string",elements:[{name:"number"},{name:"string"}]},{name:"string"}]},description:"Set a fixed height."},maxHeight:{required:!1,tsType:{name:"union",raw:"'auto' | FixedValue | PercentageValue",elements:[{name:"literal",value:"'auto'"},{name:"union",raw:"number | string",elements:[{name:"number"},{name:"string"}]},{name:"string"}]},description:"Set a maximum height."},className:{required:!1,tsType:{name:"string"},description:"@danger This is an escape hatch. It is not intended to be used normally."}}};const U=n.createContext({}),O={thead:"th",tbody:"td",tfoot:"td",div:"div"},L={outer:{paddingX:2},inner:{paddingX:2}},V={outer:{paddingX:2,paddingY:0},inner:{paddingX:1,paddingY:1}},s=({skipAsValidation:e}={})=>{const{as:t}=n.useContext(U),{cellSpacing:a,compact:i}=n.useContext(u);return!e&&!t&&console.error("This component must be wrapped in a TableHeader, TableBody or TableFooter."),{as:t,cellSpacing:a,compact:i}},E=e=>{const{as:t="div"}=s();return e||O[t]},H=()=>{const{as:e="div"}=s();return e},W=e=>{const{cellSpacing:t,compact:a}=s({skipAsValidation:e?.skipAsValidation}),i=(e?.inner||e?.outer)&&e;return t?{...t,...i}:a?{...V,...i}:{...L,...i}};export{R as T,U as a,H as b,W as c,E as d,s as u};
