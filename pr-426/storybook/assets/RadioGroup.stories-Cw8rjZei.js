import{r as t,d as R,j as e,B as _}from"./iframe-CYDANtMt.js";import{T as i}from"./Text-0g3rWpAf.js";import{C as D}from"./ControlGroup-Cf_9Xfbh.js";import{R as s}from"./Radio-Cz5dwyfU.js";import{V as w}from"./VStack-iXgNewwv.js";import"./preload-helper-D9Z9MdNV.js";import"./checkbox-DVjU0upZ.js";import"./tokens-BwScSksM.js";import"./useTheme-C_Ehsh33.js";import"./useMotionProps-BF3bCUsm.js";import"./utils-CM_X5is-.js";import"./Control-C-1dn_y_.js";import"./useMergeRefs-DR4sGa7m.js";import"./usePrefixedId-D1yZvkEs.js";import"./Interactable-DhvzqrPU.js";import"./color-Ceo1QMNe.js";import"./isRtl-CGZsgYct.js";import"./motion-minimal-B1h7XI-_.js";function B(o){return t.useCallback(a=>{o?.(a.target.value)},[o])}const S=t.forwardRef(function({label:a,value:r,onChange:g,options:b,name:h,testID:y,controlColor:f="bgPrimary",role:k="radiogroup",...G},v){R()&&console.warn('RadioGroup is deprecated. Use ControlGroup with role="radiogroup" instead.');const j=B(g),T=Object.entries(b).map(([C,N])=>({value:C,children:N,id:`${h}-${C}`,controlColor:f}));return R()&&console.warn('RadioGroup is deprecated. Use ControlGroup with role="radiogroup" instead.'),e.jsx(D,{ref:v,ControlComponent:s,label:a,name:h,onChange:j,options:T,role:k,testID:y,value:r||"",...G})}),n=t.memo(S);S.__docgenInfo={description:"",methods:[],displayName:"RadioGroupWithRef",props:{testID:{required:!1,tsType:{name:"string"},description:`Used to locate this element in unit and end-to-end tests.
