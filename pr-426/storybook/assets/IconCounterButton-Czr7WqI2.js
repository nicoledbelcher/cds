import{r as i,j as n}from"./iframe-BXWLBCkp.js";import{I as d}from"./Icon-CgDQ3NQp.js";import{H as p}from"./HStack-B6p8qBpp.js";import{P as g}from"./Pressable-sl8uFeki.js";import{T as h}from"./Text-Ch_dBU4v.js";const b=l=>{let e=1,a="";return l>=1e12?(e=1e12,a="T"):l>=1e9?(e=1e9,a="B"):l>=1e6?(e=1e6,a="M"):l>=1e3&&(e=1e3,a="K"),`${Math.floor(l/e*10)/10}${a}`},f=i.memo(i.forwardRef(function({icon:e,iconSize:a="s",size:t=a,active:u,count:r=0,color:o="fg",dangerouslySetColor:m,background:s="transparent",...v},c){return n.jsx(g,{ref:c,background:s,...v,children:n.jsxs(p,{alignItems:"center",gap:1,children:[typeof e=="string"?n.jsx(d,{active:u,color:o,dangerouslySetColor:m,name:e,size:t}):e,r>0?n.jsx(h,{mono:!0,as:"p",display:"block",font:"label1",children:b(r)}):null]})})}));f.__docgenInfo={description:"",methods:[],displayName:"IconCounterButton",props:{icon:{required:!0,tsType:{name:"union",raw:"Exclude<React.ReactNode, 'string'> | IconName",elements:[{name:"Exclude",elements:[{name:"ReactReactNode",raw:"React.ReactNode"},{name:"literal",value:"'string'"}],raw:"Exclude<React.ReactNode, 'string'>"},{name:"union",raw:`| 'account'
| 'activity'
| 'add'
| 'addPeople'
