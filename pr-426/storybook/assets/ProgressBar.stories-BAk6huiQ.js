import{r as b,j as e,c as Y,i as Z,B as ee,R as re}from"./iframe-BXWLBCkp.js";import{T as p}from"./Text-Ch_dBU4v.js";import{P as a}from"./ProgressBar-BsXln_3w.js";import{g as ae,P as o}from"./ProgressBarWithFixedLabels-CKUYTfhJ.js";import{a as se}from"./useProgressSize-CemUcfxL.js";import{u as te}from"./usePreviousValues-rLMWE3mU.js";import{u as oe}from"./useDimensions-CSIQgsxn.js";import{u as ne}from"./Pressable-sl8uFeki.js";import{V as s}from"./VStack-CnEfMFeL.js";import{c as le}from"./utils-CwomCnHN.js";import{i as E}from"./isRtl-Du0XdnX5.js";import{P as ie}from"./ProgressTextLabel-B8KufXu9.js";import{u as ce}from"./use-animation-CYeuSrS_.js";import{m as de}from"./motion-minimal-SVRWJYUW.js";import{P as t}from"./ProgressContainerWithButtons-CtqQAwU8.js";import{H as ge}from"./HStack-B6p8qBpp.js";import"./preload-helper-D9Z9MdNV.js";import"./useMotionProps-CS-LE6l8.js";import"./isArray-JxMDBx0e.js";import"./Interactable-D5HQmQer.js";import"./color-Ceo1QMNe.js";import"./useTheme-BJazYlse.js";import"./tokens-BwScSksM.js";import"./Button-W9Shg4T1.js";import"./Icon-CgDQ3NQp.js";import"./Spinner-BAI0lrZ-.js";const be="floatingTextContainerCss-f16eq1ic",pe={originX:E()?"left":"right"},ue=b.memo(({label:r,disabled:d,progress:i,disableAnimateOnMount:c,labelPlacement:g,styles:M,classNames:A})=>{const F=b.useRef(null),w=b.useRef(null),{getPreviousValue:_,addPreviousValue:N}=te([c?i:0]),T=ce(),[R,z]=b.useState(!c);N(i);const q=_()??0,{observe:J,width:D,height:H}=oe(),{value:G,render:K}=ae(r);ne(()=>{if(w.current&&F.current&&H>0&&D>0){const l=F.current.offsetWidth,I=w.current.offsetWidth,U=E()?Math.min(l-I,l-l*q):Math.max(0,l*q-I),O=E()?Math.min(l-I,l-l*i):Math.max(0,l*i-I);!R&&c?(T.set({x:O}),z(!0)):T.start({x:[U,O],transition:le(se)})}},[i,D,H,q,c]);const Q=b.useCallback(l=>{F.current=l,J(l)},[J]);return e.jsx(ee,{ref:Q,alignItems:"center",className:A?.labelContainer,paddingBottom:g==="above"?1:0,paddingTop:g==="below"?1:0,style:M?.labelContainer,testID:"cds-progress-label-container",width:"100%",children:e.jsx(de.div,{ref:w,animate:T,className:be,"data-testid":"cds-progress-bar-float-label",style:{...pe,opacity:R?1:0},children:e.jsx(ie,{className:A?.label,color:"fgMuted",disableAnimateOnMount:c,disabled:d,renderLabel:K,style:M?.label,value:G})})})}),n=b.memo(({label:r,labelPlacement:d="above",progress:i,disableAnimateOnMount:c,disabled:g,children:M,testID:A,style:F,className:w,styles:_,classNames:N})=>{const R=!Z()&&e.jsx(ue,{classNames:N,disableAnimateOnMount:c,disabled:g,label:r,labelPlacement:d,progress:i,styles:_});return e.jsxs(s,{className:Y(w,N?.root),style:{...F,..._?.root},testID:A,children:[d==="above"&&R,M,d==="below"&&R]})});n.__docgenInfo={description:"",methods:[],displayName:"ProgressBarWithFloatLabel",props:{label:{required:!0,tsType:{name:"union",raw:`| number
| {
    value: number;
