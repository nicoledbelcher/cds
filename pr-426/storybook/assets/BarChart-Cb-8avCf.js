import{r as t,j as i}from"./iframe-BXWLBCkp.js";import{g as X,d as _,C as J,X as K,Y as Q,c as Z}from"./Axis-BOWgFUiH.js";import{B as ee}from"./DefaultBar-DJlGKkOC.js";const ne=t.memo(t.forwardRef(({series:e,stacked:r,showXAxis:u,showYAxis:m,xAxis:p,yAxis:c,inset:o,children:h,barPadding:f,BarComponent:b,fillOpacity:y,stroke:v,strokeWidth:g,borderRadius:k,roundBaseline:x,BarStackComponent:w,stackGap:C,barMinSize:P,stackMinSize:S,transition:T,...q},A)=>{const R=t.useMemo(()=>X(o,Z),[o]),s=t.useMemo(()=>!r||!e?e:e.map(n=>({...n,stackId:n.stackId??_})),[e,r])??e,I=s?.map(n=>n.id),{scaleType:G,data:D,categoryPadding:W,domain:O,domainLimit:L,range:V,...E}=p||{},{scaleType:B,data:j,categoryPadding:M,domain:l,domainLimit:N,range:F,id:z,...U}=c||{},H={scaleType:G??"band",data:D,categoryPadding:W,domain:O,domainLimit:L,range:V},$=t.useMemo(()=>e?e.some(n=>n.data?.some(a=>typeof a=="number"&&a<0||Array.isArray(a)&&a.some(d=>typeof d=="number"&&d<0))):!1,[e]),Y={scaleType:B,data:j,categoryPadding:M,domain:$?l:{min:0,...l},domainLimit:N,range:F};return i.jsxs(J,{...q,ref:A,inset:R,series:s,xAxis:H,yAxis:Y,children:[u&&i.jsx(K,{...E}),m&&i.jsx(Q,{axisId:z,...U}),i.jsx(ee,{BarComponent:b,BarStackComponent:w,barMinSize:P,barPadding:f,borderRadius:k,fillOpacity:y,roundBaseline:x,seriesIds:I,stackGap:C,stackMinSize:S,stroke:v,strokeWidth:g,transition:T}),h]})}));ne.__docgenInfo={description:"",methods:[],displayName:"BarChart",props:{series:{required:!1,tsType:{name:"Array",elements:[{name:"intersection",raw:`Series & {
  /**
...
Can be a preset shape variant or a custom ReactNode.
@default 'circle'`}]}},{name:"signature",type:"object",raw:`{
  /**
   * Custom component to render bars for this series.
   */
  BarComponent?: BarComponent;
}`,signature:{properties:[{key:"BarComponent",value:{name:"ReactFC",raw:"React.FC<BarComponentProps>",elements:[{name:"intersection",raw:`Omit<BarProps, 'BarComponent'> & {
  /**
   * The path data for the bar shape.
   */
  d: SVGProps<SVGPathElement>['d'];
}`,elements:[{name:"Omit",elements:[{name:"intersection",raw:`BarBaseProps & {
  /**
   ...
   */
  BarComponent?: BarComponent;
}`,signature:{properties:[{key:"x",value:{name:"number",required:!0},description:"X coordinate of the bar (left edge)."},{key:"y",value:{name:"number",required:!0},description:"Y coordinate of the bar (top edge)."},{key:"width",value:{name:"number",required:!0},description:"Width of the bar."},{key:"height",value:{name:"number",required:!0},description:"Height of the bar."},{key:"borderRadius",value:{name:"number",required:!1},description:`Border radius for the bar.
@default 4`},{key:"roundTop",value:{name:"boolean",required:!1},description:"Whether to round the top of the bar."},{key:"roundBottom",value:{name:"boolean",required:!1},description:"Whether to round the bottom of the bar."},{key:"originY",value:{name:"number",required:!1},description:`Y coordinate of the baseline/origin for animations.
Used to calculate initial animation state.`},{key:"dataX",value:{name:"union",raw:"number | string",elements:[{name:"number"},{name:"string"}],required:!1},description:"The x-axis data value for this bar."},{key:"dataY",value:{name:"union",raw:"number | [number, number] | null",elements:[{name:"number"},{name:"tuple",raw:"[number, number]",elements:[{name:"number"},{name:"number"}]},{name:"null"}],required:!1},description:"The y-axis data value for this bar."},{key:"seriesId",value:{name:"string",required:!1},description:"The ID of the series this bar belongs to."},{key:"fill",value:{name:"string",required:!1},description:"Fill color for the bar."},{key:"fillOpacity",value:{name:"number",required:!1},description:"Fill opacity for the bar."},{key:"stroke",value:{name:"string",required:!1},description:"Stroke color for the bar outline."},{key:"strokeWidth",value:{name:"number",required:!1},description:"Stroke width for the bar outline."},{key:"BarComponent",value:{name:"BarComponent",required:!1},description:"Component to render the bar."}]}},{name:"signature",type:"object",raw:`{
  /**
   * Transition configuration for animation.
   */
  transition?: Transition;
}`,signature:{properties:[{key:"transition",value:{name:"Transition",required:!1},description:"Transition configuration for animation."}]}}]},{name:"literal",value:"'BarComponent'"}],raw:"Omit<BarProps, 'BarComponent'>"},{name:"signature",type:"object",raw:`{
  /**
   * The path data for the bar shape.
   */
  d: SVGProps<SVGPathElement>['d'];
}`,signature:{properties:[{key:"d",value:{name:"SVGProps['d']",raw:"SVGProps<SVGPathElement>['d']",required:!0},description:"The path data for the bar shape."}]}}]}],required:!1},description:"Custom component to render bars for this series."}]}}]}],raw:"Array<BarSeries>"},description:`Configuration objects that define how to visualize the data.
Each series can optionally define its own BarComponent.`},stacked:{required:!1,tsType:{name:"boolean"},description:`Whether to stack the areas on top of each other.
...
and rendered as-is.`},showXAxis:{required:!1,tsType:{name:"boolean"},description:"Whether to show the X axis."},showYAxis:{required:!1,tsType:{name:"boolean"},description:"Whether to show the Y axis."},xAxis:{required:!1,tsType:{name:"intersection",raw:"Partial<AxisConfigProps> & XAxisProps",elements:[{name:"Partial",elements:[{name:"intersection",raw:`Omit<AxisConfig, 'domain' | 'range'> & {
  /**
