import{r as o,j as a}from"./iframe-BXWLBCkp.js";import{a as i}from"./assets-CEwpm_uP.js";import{i as ie,S as se,u as T}from"./DefaultSelectControl-BVSJ3-4K.js";import{V as E}from"./VStack-CnEfMFeL.js";import{R as H}from"./RemoteImage-Lksm6NI7.js";import{R as re}from"./RemoteImageGroup-eYdFOfoJ.js";import{A as pe}from"./AnimatedCaret-DDAfukJC.js";import{M as ue}from"./MediaChip-DK4Hgf8b.js";import"./preload-helper-D9Z9MdNV.js";import"./floating-ui.react-dom-B2tvx6ll.js";import"./Portal-tAONErW2.js";import"./useTheme-BJazYlse.js";import"./Divider-DIvJbvj9.js";import"./select-Em8pkxbY.js";import"./Cell-CB_dChqK.js";import"./useCellSpacing-BuZVtSR4.js";import"./sizing-Do56D2dQ.js";import"./HStack-B6p8qBpp.js";import"./Pressable-sl8uFeki.js";import"./isArray-JxMDBx0e.js";import"./Interactable-D5HQmQer.js";import"./color-Ceo1QMNe.js";import"./Text-Ch_dBU4v.js";import"./InputChip-CbRhrkq_.js";import"./Icon-CgDQ3NQp.js";import"./HelperText-C1uG41Fa.js";import"./InputLabel-C3lBKQeI.js";import"./InputStack-DO5lXlgp.js";import"./tokens-BwScSksM.js";import"./ColorSurge-D5iBCkQQ.js";import"./useMotionProps-CS-LE6l8.js";import"./utils-CwomCnHN.js";import"./use-animation-CYeuSrS_.js";import"./motion-minimal-SVRWJYUW.js";import"./Checkbox-M1uAd9ap.js";import"./checkbox-DVjU0upZ.js";import"./Control-gdMxvYmV.js";import"./useMergeRefs-DR4sGa7m.js";import"./usePrefixedId-Dfl-0DGQ.js";import"./isRtl-Du0XdnX5.js";import"./Radio-BLJxcJvg.js";import"./FocusTrap-90tMQkIg.js";import"./debounce-fynzmAtJ.js";import"./index-B2twlf45.js";import"./use-unmount-effect-5QIafHMH.js";import"./Button-W9Shg4T1.js";import"./Spinner-BAI0lrZ-.js";import"./collapsible-BAneA-61.js";import"./context-Cc0ZOVig.js";import"./index-DoYuAu2r.js";import"./Chip-Cb6f10va.js";const F=o.memo(o.forwardRef(({type:l,options:e,value:t,placeholder:s,setOpen:r,startNode:c,endNode:m,open:j,accessibilityLabel:$,ariaHaspopup:z="listbox",className:J,style:K,maxSelectedOptionsToShow:D=2,hiddenSelectedOptionsLabel:U="more",label:B,compact:Q,invertColorScheme:X,numberOfLines:Y,disabled:Z,maxWidth:ee,displayValue:M},te)=>{const P=l==="multi",d=t!==null&&!(Array.isArray(t)&&t.length===0),W=o.useMemo(()=>{const p=new Map;return e.forEach((b,G)=>{if(ie(b))b.options.forEach((u,h)=>{if(u.value!==null){const A=u.value;p.has(A)||p.set(A,u)}});else{const u=b;if(u.value!==null){const h=u.value;p.has(h)||p.set(h,u)}}}),p},[e]),le=o.useMemo(()=>{if(!d)return B??s??null;if(M)return M;if(P){const b=t,G=b.slice(0,D),u=G.map(A=>{const _=W.get(A);return _?.label??_?.description??_?.value??""}).filter(Boolean),h=b.length-G.length;return h>0?`${u.join(", ")} +${h} ${U}`:u.join(", ")}const p=W.get(t);return p?.label??p?.description??p?.value??s??null},[d,B,s,M,P,W,t,D,U]),ae=o.useMemo(()=>m??a.jsx(pe,{active:!0,color:d?"fgInverse":"fg",rotate:j?0:180,size:"xs"}),[m,d,j]),oe=o.useMemo(()=>d?"fgInverse":"fg",[d]),ne=o.useMemo(()=>d?"bgInverse":"bgSecondary",[d]);return a.jsx(ue,{ref:te,noScaleOnPress:!0,accessibilityLabel:$,"aria-haspopup":z,background:ne,className:J,color:oe,compact:Q,disabled:Z,end:ae,invertColorScheme:X,maxWidth:ee,numberOfLines:Y,onClick:()=>r(p=>!p),start:c,style:K,children:le})})),ce=F;F.__docgenInfo={description:"",methods:[],displayName:"SelectChipControlComponent",props:{value:{required:!0,tsType:{name:"unknown"},description:""},onChange:{required:!0,tsType:{name:"signature",type:"function",raw:`(
